...
public final class NativeAdBigTypeBinding implements ViewBinding {
  @NonNull
  ...
  private NativeAdBigTypeBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FrameLayout nativeAdImageArea, @NonNull FrameLayout nativeAdMediaContainer,
      @NonNull RatingBar nativeAdStars, @NonNull View testIconView,
      @NonNull TextView txtAdAttribution) {
  ...
  @NonNull
  public static NativeAdBigTypeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeAdBigTypeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_ad_big_type, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeAdBigTypeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdBigTypeBinding((ConstraintLayout) rootView, clStar, cvAppIcon,
          nativeAdAdvertiser, nativeAdAppIcon, nativeAdBody, nativeAdCallToAction,
          nativeAdChoicesContainer, nativeAdHeadline, nativeAdImageArea, nativeAdMediaContainer,
          nativeAdStars, testIconView, txtAdAttribution);
    }
